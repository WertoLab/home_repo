...
from captcha_transformation_2.v2.split_captcha.split_captcha import *

YOUR_PATH_DATASET = "split_captcha/datasets"
YOUR_PATH_SAVE_RESULT = "/home/anika1d/PycharmWorkProject/captcha_detection/captcha_transformation/v2/split_captcha/split_captcha/datasets/result/icons"
...
def init_dataset():
    images = []
    for i in range(1, 2):
        img = cv2.imread(f"/home/anika1d/PycharmWorkProject/captcha_detection/captcha_transformation/small_icons1.png")
        images.append(img)
    return images
